...
struct FDerivedDataTrailer
{
	...
	static constexpr uint32 MagicConstant = 0x1e873d89;
	...
	explicit FDerivedDataTrailer(const TArray<uint8> Data)
		: Magic(MagicConstant)
		, Version(1)
		, CRCofPayload(FCrc::MemCrc_DEPRECATED(Data.GetData(), uint32(Data.Num())))
		, SizeOfPayload(uint32(Data.Num()))
	{
	}
