...
void UMaterialGraph::RebuildGraph()
{
	...
	if (!MaterialFunction)
	{
		...
		MaterialInputs.Add( FMaterialInputInfo(FMaterialAttributeDefinitionMap::GetDisplayNameForMaterial(MP_Normal, Material), MP_Normal, LOCTEXT( "NormalToolTip", "Takes the input of a normal map. Should alwyas be in ObjectSpace." ) ) );
