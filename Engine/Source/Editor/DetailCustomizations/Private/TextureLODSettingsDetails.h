...
private:
	...
	// Controls for the LOD Bias VT property editing
	int32 GetLODBiasVT() const;
	void OnLODBiasVTChanged(int32 NewValue);
	void OnLODBiasVTCommitted(int32 NewValue, ETextCommit::Type TextCommitType);
