...
void FMatrixStructCustomization::CustomizeRotation(TSharedRef<class IPropertyHandle> StructPropertyHandle, FDetailWidgetRow& Row, TOptional<FText> OverrideName)
{
	TWeakPtr<IPropertyHandle> WeakHandlePtr = StructPropertyHandle;
