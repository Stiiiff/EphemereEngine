...
struct FShaderStatsInfo
{
	...
	void Reset()
	{
		...
		VirtualTextureStackCount.StrDescription = TEXT("Compiling...");
		VirtualTextureStackCount.StrDescriptionLong = TEXT("Compiling...");
	...
	void Empty()
	{
		...
		VirtualTextureStackCount.StrDescription.Empty();
		VirtualTextureStackCount.StrDescriptionLong.Empty();
