...
/** this row will display the global number of virtual texture stacks present in the material for a specified platform */
class FStatsGridRow_NumVirtualTextureStacks : public FStatsGridRow
{
public:
	void CreateRow(TSharedPtr<FMaterialStats> StatsManager) override;
