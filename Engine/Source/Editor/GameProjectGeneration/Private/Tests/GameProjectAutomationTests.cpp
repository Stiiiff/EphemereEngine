...
namespace GameProjectAutomationUtils
{
	...
	*/
	 ...
	 */
	static void CreateProjectSet(TMap<FName, TArray<TSharedPtr<FTemplateItem>> >& InTemplates, EHardwareClass::Type InTargetedHardware, EGraphicsPreset::Type InGraphicPreset, FName InCategory, int32 &OutCreatedProjects, int32 &OutMatchedProjects)
	{		
