...
#if !PLATFORM_LINUX // Fullscreen mode in the editor is currently unsupported on Linux
...
void FMainFrameActionCallbacks::PackageProject( const FName InPlatformInfoName )
{
	...
	if (PackagingSettings->IncludeCrashReporter && PlatformInfo && PlatformInfo->bTargetPlatformCanUseCrashReporter)
	{
