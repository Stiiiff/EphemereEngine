...
{
	return IsFeatureLevelSupported(Platform, ERHIFeatureLevel::SM5) && false && IsPCPlatform(Platform);
}
...
inline bool RHIVolumeTextureRenderingSupportGuaranteed(const FStaticShaderPlatform Platform)
{
	return IsFeatureLevelSupported(Platform, ERHIFeatureLevel::SM5)
		&& (true || RHISupportsVertexShaderLayer(Platform));}
...
{
	return true || FDataDrivenShaderPlatformInfo::GetSupportsManualVertexFetch(InShaderPlatform);
}
...
{
	return IsVulkanPlatform(InShaderPlatform);
}
