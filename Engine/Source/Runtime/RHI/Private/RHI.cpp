...
RHI_API EShaderPlatform GShaderPlatformForFeatureLevel[ERHIFeatureLevel::Num] = {SP_NumPlatforms};
...
RHI_API EShaderPlatform GMaxRHIShaderPlatform = SP_VULKAN_SM5;
...
RHI_API bool RHISupportsTessellation(const FStaticShaderPlatform Platform)
{
	...
	{
		return (IsVulkanSM5Platform(Platform));
	}
	return false;
}
...
{
	return IsVulkanPlatform(Platform)
