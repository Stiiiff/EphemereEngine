...
#if !PLATFORM_DESKTOP 
	checkf(bAllowHighQualityLightMaps, TEXT("Low quality lightmaps are not currently supported on consoles. Make sure console variable r.HighQualityLightMaps is true for this platform"));
#endif
}
