...
struct FStatRenderGlobals
{
	 ...
	 */
	void Initialize( const int32 InSizeX, const int32 InSizeY, const int32 InSafeSizeX)
	{
...
void RenderStats(FViewport* Viewport, class FCanvas* Canvas, int32 X, int32 Y, int32 SafeSizeX)
{
	...
	Globals.Initialize( Viewport->GetSizeXY().X/Canvas->GetDPIScale(), Viewport->GetSizeXY().Y/Canvas->GetDPIScale(), SafeSizeX );
