...
void FBufferVisualizationData::ConfigureConsoleCommand()
{
	...
	IConsoleManager::Get().RegisterConsoleVariable(
		...
		TEXT("BaseColor,SceneColor,WorldNormal,Roughness,SubsurfaceColor,,,WorldTangent,SeparateTranslucencyA,,,Opacity,SceneDepth,SeparateTranslucencyRGB,ShadingShape,ShadingModel,SeparateTranslucencyRGB,SceneDepthWorldUnits,PreTonemapHDRColor,PostTonemapHDRColor"),
