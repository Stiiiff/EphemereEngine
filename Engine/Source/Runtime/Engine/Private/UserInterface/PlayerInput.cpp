...
struct FDelegateDispatchDetails
{
	...
	FDelegateDispatchDetails(const uint32 InEventIndex, const uint32 InFoundIndex, const FVector InLocation)
		: EventIndex(InEventIndex)
		, FoundIndex(InFoundIndex)
	{}

	FDelegateDispatchDetails(const uint32 InEventIndex, const uint32 InFoundIndex, const float InValue)
		: EventIndex(InEventIndex)
		, FoundIndex(InFoundIndex)
	{}
};
