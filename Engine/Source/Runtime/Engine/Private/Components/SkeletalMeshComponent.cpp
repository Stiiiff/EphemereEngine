...
bool USkeletalMeshComponent::IsEndPhysicsTickFunctionEnabled() const
{
	return EndPhysicsTickFunction.IsTickFunctionRegistered() && EndPhysicsTickFunction.IsTickFunctionEnabled();
}
