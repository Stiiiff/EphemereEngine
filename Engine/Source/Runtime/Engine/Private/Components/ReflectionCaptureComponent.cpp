...
void GenerateEncodedHDRTextureCube(UMapBuildDataRegistry* Registry, FReflectionCaptureData& ReflectionCaptureData, FString& TextureName, float MaxValueRGBM, UReflectionCaptureComponent* CaptureComponent)
{
#if WITH_EDITOR
	...
	if (TextureCube)
	{
		...
		TextureCube->CompressionNone = true;
