...
enum EMaterialShadingModel
{
	...
	MSM_Lit						UMETA(DisplayName="Lit"),
	MSM_Skin					UMETA(DisplayName="Skin"),
	MSM_Metal					UMETA(DisplayName="Metal"),
	MSM_Foliage					UMETA(DisplayName="Foliage"),
	MSM_Hair					UMETA(DisplayName="Hair"),
	MSM_Clothing				UMETA(DisplayName="Cloth"),
	MSM_ThickTranslucent		UMETA(DisplayName="ThickTranslucent"),
...
static_assert(MSM_NUM <= 8, "Do not exceed 8 shading models without expanding FMaterialShadingModelField to support uint16 instead of uint8!");
...
public:
	...
	void AddShadingModel(EMaterialShadingModel InShadingModel)				{ check(InShadingModel < MSM_NUM); ShadingModelField |= (1 << (uint8)InShadingModel); }
	void RemoveShadingModel(EMaterialShadingModel InShadingModel)			{ ShadingModelField &= ~(1 << (uint8)InShadingModel); }
	...
	bool HasShadingModel(EMaterialShadingModel InShadingModel) const		{ return (ShadingModelField & (1 << (uint8)InShadingModel)) != 0; }
	bool HasOnlyShadingModel(EMaterialShadingModel InShadingModel) const	{ return ShadingModelField == (1 << (uint8)InShadingModel); }
...
enum EMaterialSamplerType
{
	...
	SAMPLERTYPE_PackedNormal UMETA(DisplayName = "Packed Normal"),
	...
	SAMPLERTYPE_VirtualPackedNormal UMETA(DisplayName = "Virtual Packed Normal"),
