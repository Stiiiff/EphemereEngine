...
UCLASS(ClassGroup=Lights, hidecategories=(Input,Collision,Replication,Info), showcategories=("Rendering", "Input|MouseInput"), ComponentWrapperClass, ConversionRoot, Blueprintable)
