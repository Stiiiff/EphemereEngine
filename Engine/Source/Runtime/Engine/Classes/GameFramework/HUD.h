 ...
 * @see FDebugTextInfo
 */
UCLASS(config=Game, hidecategories=(Rendering,Actor,Input,Replication), showcategories=("Input|MouseInput"), notplaceable, transient, BlueprintType, Blueprintable)
