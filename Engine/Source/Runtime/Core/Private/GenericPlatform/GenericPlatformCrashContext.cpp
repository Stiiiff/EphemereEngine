...
void FGenericCrashContext::Initialize()
{
	...
	NCached::Session.CPUModelID = FPlatformMisc::GetCPUModelID();
	NCached::Session.CPUMicrocodeRevision = FPlatformMisc::GetCPUMicrocodeRevision();
...
void FGenericCrashContext::SerializeSessionContext(FString& Buffer)
{
	...
	AddCrashPropertyInternal(Buffer, TEXT("Misc.CPUModelID"), NCached::Session.CPUModelID);
	AddCrashPropertyInternal(Buffer, TEXT("Misc.CPUMicrocodeRevision"), NCached::Session.CPUMicrocodeRevision);
