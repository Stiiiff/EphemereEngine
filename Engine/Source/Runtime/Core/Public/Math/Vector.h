...
public:
	 ...
	 */
	FVector GetSafeNormal2D(float Tolerance=SMALL_NUMBER, const FVector& ResultIfZero = ZeroVector) const;
...
FORCEINLINE FVector FVector::GetSafeNormal(float Tolerance, const FVector& ResultIfZero) const
{
	const float SquareSum = X*X + Y*Y + Z*Z;
...
FORCEINLINE FVector FVector::GetSafeNormal2D(float Tolerance, const FVector& ResultIfZero) const
{
