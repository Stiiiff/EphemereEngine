...
//#endif
	...
	public:
		...
		inline FReal Dot(const TVector<FReal, 3>& V) const { return FVector::DotProduct(*this, V); }
		...
		FORCEINLINE FReal Length() const
		{
			return Size();
		}
		
		FORCEINLINE FReal SquaredLength() const
		{
			return SizeSquared();
		}

		static FORCEINLINE TVector<FReal, 3> Zero() { return ZeroVector; }
	};
...
#define MakeVectorRegisterConstant(x,y,z,w) VectorRegister{ x, y, z, w }
