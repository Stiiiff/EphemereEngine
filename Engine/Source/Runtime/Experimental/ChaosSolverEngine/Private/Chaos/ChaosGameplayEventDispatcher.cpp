...
static void DispatchPendingRemovalEvents(TArray<FChaosRemovalEvent> const& Events, TMap<UPrimitiveComponent*, FRemovalEventCallbackWrapper> const& Registrations)
{
