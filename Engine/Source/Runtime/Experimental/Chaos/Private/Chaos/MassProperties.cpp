...
namespace Chaos
{
	FRotation3 TransformToLocalSpace(FMatrix33& Inertia)
	{
		...
		FReal Size = static_cast<FReal>(FMath::Sqrt(static_cast<FReal>((FMath::Square(Inertia.M[0][0] - Trace) + FMath::Square(Inertia.M[1][1] - Trace) + FMath::Square(Inertia.M[2][2] - Trace) + 2. * OffDiagSize) / 6.)));
