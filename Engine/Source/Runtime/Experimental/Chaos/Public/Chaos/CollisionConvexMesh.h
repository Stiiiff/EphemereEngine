...
namespace Chaos
{
	...
	public:
		...
		static bool IsPlanarShape(const TArray<FVec3Type>& InVertices, FVec3Type& OutNormal)
		{
			...
			{
				const FPlane TriPlane(InVertices[0], InVertices[1], InVertices[2]);
				OutNormal = FVec3Type(TriPlane.X, TriPlane.Y, TriPlane.Z);
	...
	public:
		...
		{
			const FMatrix33 FaceMatrix = FRotationMatrix::MakeFromZ(Face.Normal());
