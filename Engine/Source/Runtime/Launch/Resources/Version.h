...
// These numbers define the banner UE version, and are the most significant numbers when ordering two engine versions (that is, a 4.12.* version is always 
...
// was unintended.
#ifdef __cplusplus
static_assert(ENGINE_MAJOR_VERSION == 4 && ENGINE_MINOR_VERSION == 27 && ENGINE_PATCH_VERSION == 2); //-V501
#endif // __cplusplus
