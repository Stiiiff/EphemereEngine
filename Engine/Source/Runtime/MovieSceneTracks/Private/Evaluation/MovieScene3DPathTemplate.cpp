	...
	: IMovieSceneExecutionToken
{
	...
	void Eval(USceneComponent* SceneComponent, USplineComponent* SplineComponent, FVector& OutTranslation, FRotator& OutRotation)
	{
		...
		OutTranslation = SplineComponent->GetLocationAtTime(Timing, ESplineCoordinateSpace::World, UseConstantVelocity);
		OutRotation = SplineComponent->GetRotationAtTime(Timing, ESplineCoordinateSpace::World,UseConstantVelocity);
