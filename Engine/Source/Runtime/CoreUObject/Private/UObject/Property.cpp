...
{
	checkf(false, TEXT("Missing implementation for GetValueTypeHashInternal with ID %s and Name %s"), *GetID().ToString(), *GetName()); // you need to deal with the virtual call
	return 0;
}
