...
private:
	...
	void GenerateEuclideanTethers(const TConstArrayView<FVector>& Points);

	// Generate a map of tethers by following the triangle mesh network
	// The choice of the tether is determined by the shortest geodesic (curvature) distance.
	void GenerateGeodesicTethers(const TConstArrayView<FVector>& Points, const TConstArrayView<float>& MaxDistances);
...
void FClothTetherDataPrivate::GenerateEuclideanTethers(const TConstArrayView<FVector>& Points)
{
...
void FClothTetherDataPrivate::GenerateGeodesicTethers(const TConstArrayView<FVector>& Points, const TConstArrayView<float>& MaxDistances)
{
	check(KinematicNodeIslands.Num());
