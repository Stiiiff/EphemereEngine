...
public:
	...
	void AdvanceFrame(uint32 InOcclusionFrameCounter, uint32 InNumBufferedFrames);
...
public:
	...
	FVector4 SkyAtmosphereAmbientContributionColorScale;
	FVector VolumetricFogAlbedo;
