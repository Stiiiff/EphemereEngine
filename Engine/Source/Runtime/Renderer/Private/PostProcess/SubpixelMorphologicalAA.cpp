...
public:
	...
	BEGIN_SHADER_PARAMETER_STRUCT(FParameters, )
		...
		SHADER_PARAMETER(FVector4, RTMetrics)
...
void AddSMAAEdgeDetectionPass(FRDGBuilder& GraphBuilder, const FViewInfo& View, const FScreenPassTexture& SceneColorTexture, const FRDGTextureRef& EdgeTexture, const FRDGTextureRef& DepthStencilTexture, ESMAAQuality Quality, const FVector4& RTMetrics)
{
...
void AddSMAABlendingWeightCalculationPass(FRDGBuilder& GraphBuilder, const FViewInfo& View, const FRDGTextureRef& EdgeTexture, const FRDGTextureRef& BlendTexture, const FRDGTextureRef& DepthStencilTexture, ESMAAQuality Quality, const FVector4& RTMetrics)
{
	checkSlow(View.bIsViewInfo);
...
FScreenPassTexture AddSMAANeighborhoodBlendingPass(FRDGBuilder& GraphBuilder, const FViewInfo& View, const FScreenPassTexture& InputSceneTexture, const FRDGTextureRef& InputBlendTex, FScreenPassRenderTarget& Output, const FVector4& RTMetrics)
{
	checkSlow(View.bIsViewInfo);
...
FScreenPassTexture AddSMAADebugVisualizationPass(FRDGBuilder& GraphBuilder, const FViewInfo& View, const FScreenPassTexture& InputSceneTexture, const FRDGTextureRef& InputEdgeTex, const FRDGTextureRef& InputBlendTex, FScreenPassRenderTarget& Output, const FVector4& RTMetrics)
{
	checkSlow(View.bIsViewInfo);
...
FScreenPassTexture AddSMAAPasses(FRDGBuilder& GraphBuilder, const FViewInfo& View, const FSMAAInputs& Inputs)
{
	...
	FVector4 RTMetrics = FVector4(1.0f / TexSize.X, 1.0f / TexSize.Y, TexSize.X, TexSize.Y);
