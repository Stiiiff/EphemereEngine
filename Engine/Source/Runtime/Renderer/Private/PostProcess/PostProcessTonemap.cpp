...
bool ShouldCompileCommonPermutation(const FGlobalShaderPermutationParameters& Parameters, const FCommonDomain& PermutationVector)
{
	...
	if (PermutationVector.Get<FTonemapperSwitchAxis>())
	{
		return false;
	}

	if (PermutationVector.Get<FTonemapperUseFXAA>())
	{
		return false;
	}
...
public:
	...
	static bool ShouldCompilePermutation(const FGlobalShaderPermutationParameters& Parameters)
	{
		...
		// Prevent switch axis permutation on platforms that dont require it.
		if (PermutationVector.Get<TonemapperPermutation::FTonemapperSwitchAxis>())
		{
			return false;
		}
		return true;
