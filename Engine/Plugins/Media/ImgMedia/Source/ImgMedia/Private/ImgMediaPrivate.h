...
/** The OpenEXR image reader is supported on Windows, and Linux only. */
#define IMGMEDIA_EXR_SUPPORTED_PLATFORM (PLATFORM_WINDOWS || (PLATFORM_LINUX && PLATFORM_CPU_X86_FAMILY))
