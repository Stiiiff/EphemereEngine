...
const FVisualizationOption FVisualizationOption::OptionData[] = 
{
	...
	FVisualizationOption(&Chaos::FClothingSimulation::DebugDrawPointVelocities     , LOCTEXT("ChaosVisName_PointVelocities"     , "Point Velocities"           ), LOCTEXT("ChaosVisName_PointVelocities_ToolTip"     , "Draws the current point velocities for the simulation mesh")),
