...
private:
	...
	AConcertClientPresenceActor* CreatePresenceActor(const FConcertClientInfo& InClientInfo );

	/** Spawn a presence actor */
	AConcertClientPresenceActor* SpawnPresenceActor(const FConcertClientInfo& InClientInfo );
	...
	void UpdatePresenceAvatar(const FGuid& InEndpointId);
