...
public:		
	...
	bool IsAsyncLoadingGameplayCueNotifyClass(const FSoftObjectPath& CueNotifyClass) const;
...
protected:
	...
	void OnMissingCueAsyncLoadComplete(FSoftObjectPath LoadedNotifyClass);
