...
UCLASS(config = EditorPerProjectUserSettings)
class UUniformFractureSettings
	: public UObject
{
	GENERATED_BODY()
public:
...
UCLASS(config = EditorPerProjectUserSettings)
class UClusterFractureSettings
	: public UObject
{
	GENERATED_BODY()
public:
...
UCLASS(config = EditorPerProjectUserSettings)
class USlicingFractureSettings
	: public UObject
{
	GENERATED_BODY()
public:
...
UCLASS(config = EditorPerProjectUserSettings)
class UPlaneCutFractureSettings
	: public UObject
{
	GENERATED_BODY()
public:
